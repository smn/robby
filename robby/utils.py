# Hey, these have been lifted straight from Jart's awesome redisbayes
# implementation at:
#   https://github.com/jart/redisbayes/blob/master/redisbayes.py
#
# Copied them here so I don't need to add redisbayes as a dependency
# and have it pull the sync `redis` package which I cannot use in
# Twisted
